...
const getClass = (tag: string) => {
 ...
 mandatoryHeaders = {["Article Id","Title"]}
   mandatoryBodyKeys = {["article_id","title"]}
                  ...
                  data={data}
                  headers={headers}
                  fileNamePrefix="Qc Valid ICSR List"
                  fileSavedName={`${
                    Utils.getUserData()?.user_name
                  }_QcValidICSRList_${Utils.getCurrentDateAndTime()}`}
                  disable={false}
                  searchRow={undefined}
                  startRow={undefined}
                  endRow={undefined}
...
<th className="px-2 py-4 w-32 hover-text-style">AI Tags</th> 
                  ...
                  sortedData
                    ...
                    .map((item, index) => (
                      ...
                      >
                        ...
                        <td
                          className="w-40 py-4 cursor-pointer break-words text-center"
                          onClick={() => {
                            handleClick(item);
                          }}
                        >
  ...
  {item?.ai_tags?.Medications ? (
    ...
    <div className={`text-center`}>{"-"}</div>
                        ...
                        <td
                          className="p-3 text-black capitalize w-20 text-center"
                          onClick={() => {
                            handleClick(item);
                          }}
                        >
