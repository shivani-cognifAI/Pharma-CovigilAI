...
import HeaderRowSelectionComponent from "@/common/HeaderRowSelectionModal";
...
const Completed: React.FC<IProps> = ({ label }) => {
...
const[defaultPage,setDefaultPage] = useState(GetPageCount)
  ...
  const [isRowExportModalOpen, setIsRowExportModalOpen] = useState(false);
...
"adverse_reaction":"adverse_reaction"
  ...
  const isPublishedOnSelected = csvHeaders.includes('Published On');
    ...
    const { article_id, updated_on, ...rest } = item;
...
if (allArticleIdsAreNumeric) {
 ...
 mandatoryHeaders = {["Id","Name"]}
   mandatoryBodyKeys = {["monitor_id","name"]}
                  ...
                  headers={headers}
                  fileNamePrefix="QC Completed List"
                  fileSavedName={`${
                    Utils.getUserData()?.user_name
                  }_QCCompletedList_${Utils.getCurrentDateAndTime()}`}
                  disable={false}
                  searchRow={undefined}
                  startRow={undefined}
                  endRow={undefined}
            ...
            <table className="w-[100%] text-14 border border-collapse table-auto">
              <thead className="border-style text-sm ">
                <tr className="font-Archivo capitalize text-style text-sm bg-gray-50">
                  ...
                  <th className="pl-3 w-20 hover-text-style items-center text-center cursor-pointer">
                    Description
                  </th>
                  <th className="px-2 py-3 w-32 text-center hover-text-style date-created-width">
                  ...
                  <th className="px-4 w-20 py-3 ml-8 text-center">
                  ...
                  <th className="px-2 w-18 py-3 ml-8">
                  ...
                  sortedFilteredData
                    ...
                    .map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-6 text-center relative cursor-pointer">
