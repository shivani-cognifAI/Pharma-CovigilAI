...
if (
  ...
  /**
   * Sorts and filters data based on the sort configuration.
   */
...
mandatoryHeaders = {["Id","Name"]}
   mandatoryBodyKeys = {["monitor_id","name"]}
                  ...
                  headers={headers}
                  fileNamePrefix="QC Inprogress List"
                  fileSavedName={`${
                    Utils.getUserData()?.user_name
                  }_QCInprogressList_${Utils.getCurrentDateAndTime()}`}
                  disable={false}
                  searchRow={undefined}
                  startRow={undefined}
                  endRow={undefined}
          ...
          <div className="overflow-style">
            <table className="w-[100%] text-14 border border-collapse table-auto">
              <thead className="border-style text-sm text-center text-center">
