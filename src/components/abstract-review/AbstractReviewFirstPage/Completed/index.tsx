...
if (allArticleIdsAreNumeric) {
 ...
 mandatoryHeaders = {["Id","Name"]}
   mandatoryBodyKeys = {["monitor_id","name"]}
                  ...
                  headers={headers}
                  fileNamePrefix="Abstart Review Completed List"
                  fileSavedName={`${
                    Utils.getUserData()?.user_name
                  }_AbstartReviewCompletedList_${Utils.getCurrentDateAndTime()}`}
                  disable={false}
                  searchRow={undefined}
                  startRow={undefined}
                  endRow={undefined}
          ...
          <div className="overflow-style">
            <table className="w-[100%] border text-14 border-collapse table-auto">
              <thead className="border-style text-sm ">
                <tr className="font-Archivo capitalize text-style text-sm text-center bg-gray-50">
                  ...
                  <th className="px-2 w-18 py-3 ml-8">
                    <div className="relative">
                      <span className="flex w-full px-1 py-4 hover-text-style items-center text-center cursor-pointer">
                        Action
                      </span>
                    </div>
                  </th>
                  ...
                  sortedFilteredData
                    ...
                    .map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-4 text-center py-6 relative cursor-pointer">
