...
const InProgress: React.FC<IProps> = ({ label }) => {
...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    updateData();
  }, [status, TotalInProgressCount, abstractReviewInProgressData]);
...
drug_of_choice: Array.isArray(drug_of_choice) ? drug_of_choice.join(", ") : drug_of_choice,
      ...
      // Step 5: Export the data to Excel
 ...
 mandatoryHeaders = {["Id","Name"]}
   mandatoryBodyKeys = {["monitor_id","name"]}
                  ...
                  headers={headers}
                  fileNamePrefix="Abstart Review Inprogress List"
                  fileSavedName={`${
                    Utils.getUserData()?.user_name
                  }_AbstartReviewInprogressList_${Utils.getCurrentDateAndTime()}`}
                  disable={false}
                  searchRow={undefined}
                  startRow={undefined}
                  endRow={undefined}
            ...
            <table className="w-[100%] border text-14 border-collapse table-auto">
              <thead className="border-style text-sm ">
                <tr className="font-Archivo capitalize text-style text-sm bg-gray-50">
                  ...
                  <th className="px-2 py-3 w-32 hover-text-style date-created-width text-center">
                  ...
                  <th className="px-2 w-32 py-3 text-center">
                  ...
                  <th className=" w-32 py-3 ml-4 text-center ">
                  ...
                  <th className="px-4 w-32 py-3 ml-8 text-center">
                  ...
                  <th className="px-1 w-28 py-3 ml-8 text-center ">
                  ...
                  <th className="px-1 w-28 text-center text-center hover-text-style">
                    Frequency
                  </th>
                  <th className="px-1 w-20 text-center hover-text-style">
                    Export
                  </th>
                  <th className="px-2 w-18 py-3 ml-8 text-center">
                    <div className="relative">
                      <span className="flex w-full px-1 py-4 hover-text-style items-center cursor-pointer">
                        Action
                      </span>
                    </div>
                  </th>
                  ...
                  sortedFilteredData
                    ...
                    .map((item, index) => (
                      ...
                      >
                        ...
                        <td
                          className={`text-left px-2 py-6 w-[300px] break-words text-lightslategray`}
                          onClick={() => handleRowClick(item)}
                        >
                          {item.description}
                        </td>
                        <td
                          className="text-center px-4 py-6 text-lightslategray date-width"
                          onClick={() => handleRowClick(item)}
                        >
                          {item?.created_on
                        ...
                        <td
                          className=" px-6  py-6 text-lightslategray date-width "
                          onClick={() => handleRowClick(item)}
                        >
                          {item?.to_date}
                        </td>
                        <td
                          className="text-center px-2 py-6 text-lightslategray"
                          onClick={() => handleRowClick(item)}
                        >
                          {item?.total_records}
                        </td>
                        <td
                          className="text-center px-4 py-6 text-lightslategray"
                          onClick={() => handleRowClick(item)}
                        >
                          {item?.status}
                        </td>
                        ...
                        <td className="px-4 items-start text-center py-6 relative cursor-pointer">
                          <div ref={actionRef} className="relative -ml-4">
                            <Image
