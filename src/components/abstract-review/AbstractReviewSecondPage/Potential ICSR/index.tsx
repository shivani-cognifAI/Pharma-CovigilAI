...
const PotentialICSR: React.FC<IProps> = ({ monitor_id, label }) => {
...
const[defaultPage,setDefaultPage] = useState(GetPageCount)
 ...
 mandatoryHeaders = {["Article Id","Title"]}
   mandatoryBodyKeys = {["article_id","title"]}
                  ...
                  data={data}
                  headers={headers}
                  fileNamePrefix="Potential ICSR List"
                  fileSavedName={`${
                    Utils.getUserData()?.user_name
                  }_Potential_ICSR_List_${Utils.getCurrentDateAndTime()}`}
                  disable={false}
                  searchRow={undefined}
                  startRow={undefined}
                  endRow={undefined}
            ...
            <table className="w-full text-14 border border-collapse table-auto">
              <thead className="border-style text-sm text-center">
                <tr className="font-Archivo cursor-pointer header-style capitalize text-style text-sm bg-gray-50">
                  ...
                  <th className=" px-2 py-2 w-20 hover-text-style">Title</th>
  ...
  {item?.ai_tags?.Medications ? (
    ...
    <div className={`text-center`}></div>
                        ...
                        <td className="px-2 text-center w-20 capitalize">
                        ...
                        <td className="px-2 text-center w-24 capitalize">
                          {item?.status}
                        </td>
                        <td className="px-2 text-center w-20 capitalize">
                          {item.modified_by}
